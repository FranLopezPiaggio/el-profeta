            ...
            <aside className="w-64 bg-white border-r border-brand-green2/10 flex flex-col justify-between hidden md:flex shrink-0">
                <div className="p-6 space-y-8">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="w-20 h-20 flex items-center justify-center text-brand-gold shadow-sm">
                            <Image
                ...
                <div className="p-4 m-4 rounded-2xl bg-brand-bone-white/60 border border-brand-green2/10 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-brand-green2/10 text-brand-green2 flex items-center justify-center font-bold text-xs">
                            AD
                        </div>
                        <div>
                            <p className="text-xs font-bold text-brand-black">Admin Profeta</p>
                            <p className="text-[10px] text-brand-black/50">admin@elprofeta.com</p>
                        </div>
                    </div>
                    <button className="text-brand-black/40 hover:text-brand-black transition-colors cursor-pointer">
